...
namespace HotelManagement
{
    public class DataConnectSQL
    {
        ...
        public static int ExcuteProcedure(string query, string user, int numGuest, int numRoom, DateTime checkIn, DateTime checkOut)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@num_Guest", numGuest);
